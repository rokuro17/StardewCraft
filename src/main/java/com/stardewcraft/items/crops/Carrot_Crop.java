...
public class Carrot_Crop extends CropBlock {
    ...
    public Carrot_Crop(AbstractBlock.Settings settings) {
        super(settings);
    }
    /**
     * Method that returns the seeds item for the Carrot crop
     * @return int This returns the seeds item
     */
    @Override
    public ItemConvertible getSeedsItem() {
        return StardewCraft.CARROT_SEEDS;
    }
    /**
